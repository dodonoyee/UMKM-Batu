                    ...
                    <div class="info">
                        <ul>
                            <li>
                                ...
                                <p>(_62) 822 2847 5293 <br> (+62) 858 1515 2090</p>

                            </li>
                            <li>
                                <h4><i class="fa fa-map-marker"></i>Address</h4>
                                <p>Imam Bonjol Bawah Street Gg. I No.25, Sisir, Kec. Batu, Batu City, East Java 65314</p>
                            </li>
                            <li>
                                <h4><i class="fa fa-envelope"></i>Email</h4>
                                <p>rotimickyofficial@gmail.com - nhkjordy@mail.ru</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="block">
                    <p>Copyright &copy; 2021 - All Rights Reserved.Design and Developed By Rohmadhona Wahu Eko Saputro</p>
                </div>
            </div>
        </div>
    </div>
